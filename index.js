...
async function run() {
    ...
    const llamaAuctionHouseContract = new ethers.Contract(llamaAuctionHouse, llamaAuctionHouseAbi, wallet)
    ...
    const settlementTx = await llamaAuctionHouseContract.settle_current_and_create_new_auction(overrides);
